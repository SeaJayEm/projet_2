...
<style>
    ...
    .stApp {
            background-image: url("https://raw.githubusercontent.com/SeaJayEm/projet_2/refs/heads/main/felix-mooneeram-evlkOfkQ5rE-unsplash.jpg");
...
def main():
    def afficher_contenu(selection):
        if selection == "Accueil":
            st.markdown("<h2 style='font-size: 35px; text-align: center;'>🎥 Bienvenue dans l'Antre des Cinéphiles 🎥</h2>", unsafe_allow_html=True)            
            st.markdown("<h3 style='font-size: 25px; text-align: center;'>Explorez les classiques du cinéma des années 60 et 70 à travers notre interface interactive.</h3><br>", unsafe_allow_html=True)            
            ...
            st.markdown("<h2 style='font-size: 35px; text-align: center;'>📊 Statistiques de la Base de Données 📊</h2><br>", unsafe_allow_html=True)            
            ...
            st.markdown("<h3 style='font-size: 25px;'>Statistiques globales</h1>", unsafe_allow_html=True)            
            ...
            st.markdown("<h2 style='font-size: 35px; text-align: center;'>🎥 Moteur de recommandations de films 🎥</h2><br>", unsafe_allow_html=True)             # Chargement et préparation des données
            ...
            st.markdown(
                ...
                <h3 class="radio-label" style="font-size: 24px;">Choisissez votre mode de recherche :</h3>
                """,
                unsafe_allow_html=True,
            )            
            mode = st.radio(
                "",
                ["Recherche par titre - je veux des recommandations basées sur un film que j'aime. 😍", "Recherche par filtres - je veux explorer les films par genre, réalisateur, acteur, ou pays. 🔍", "Surprends moi ! 😮"]
            )
            
            if mode == "Recherche par titre - je veux des recommandations basées sur un film que j'aime. 😍":
